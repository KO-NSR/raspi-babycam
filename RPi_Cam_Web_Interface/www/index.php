...
<html>
   <head>
      ...
      <script src="js/sensorValue_now.js"></script>
   </head>
   <body onload="setTimeout('init(<?php echo "$mjpegmode, $video_fps, $divider" ?>);', 100);">
	  ...
	  <?php simple_button(); ?>
      <div style="font-size: 32px; font-weight: bold; color: black; margin: 10px 0; text-align: center; ">
        <span id="temp-value">温度：ｰｰ°C</span>
        <span style="display:inline-block; width: 80px;"></span>
        <span id="humi-value">湿度：ｰｰ%</span>
      </div>
